...
export default function LandingPage() {
  ...
  function sign() {
    signInWithPopup(auth, provider).then((res) => {
      ...
      axios
        .post("http://localhost:5002/api/user/verification", {
        ...
        <div className="w-3/4 bg-orange-400">
          <div className="bg-orange-500 min-h-screen">
            <div className="container w-[80%] ml-[10%]">
              <h1 className="text-4xl font-bold text-white mb-8 ml-[26%] pt-[2%]">
                Welcome to Querulous
              </h1>

              <div className="bg-white p-8 rounded-lg shadow-lg">
                <h2 className="text-2xl font-semibold mb-4">
                  Solving Everyday Problems, One Solution at a Time
                </h2>

                <div className="mb-6">
                  <h3 className="text-xl font-medium mb-2">Why Choose Us?</h3>
                  <p className="text-gray-700">
                    In the hustle and bustle of daily life, we all encounter
                    challenges that can be a bit overwhelming. Whether it&apos;s
                    managing time, improving productivity, or simply finding a
                    better way to do something, the quest for solutions is
                    constant.
                  </p>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <ul className="list-disc list-inside text-gray-700">
                    <li>
                      Practical Tips & Tricks: Learn from our community of
                      problem-solvers who share their best practices and
                      insights.
                    </li>
                    <li>
                      Curated Resources: Discover a handpicked selection of
                      tools, apps, and resources designed to make your daily
                      tasks easier.
                    </li>
                    <li>
                      Inspiring Stories: Be inspired by real-life stories of
                      individuals who have successfully overcome obstacles in
                      their lives.
                    </li>
                  </ul>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-700">
                    Become a part of our growing community of problem-solvers!
                    Share your own tips and tricks, connect with like-minded
                    individuals, and contribute to a collective knowledge base
